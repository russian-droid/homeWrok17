...
money[25, 25, 50]
money[25, 100]
money[25, 25, 50, 50, 100]

ticket = 25
#start checking every element minus ticket price ($25)
change = money[2] - ticket
if change == 0:
    print('YES')
else:
    for x in money:
...
#start checking if we can give change from existing bills 
if change - money[1] - money[0] == 0:
    print('YES')
else:
    print('NO')
